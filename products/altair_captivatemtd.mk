...
#
PRODUCT_NAME := altair_captivatemtd
...
#PRODUCT_SPECIFIC_DEFINES += TARGET_KERNEL_CONFIG=altair_captivate_defconfig

# Extra captivate overlay
PRODUCT_PACKAGE_OVERLAYS += vendor/altair/overlay/captivatemtd
