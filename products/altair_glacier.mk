...
#PRODUCT_SPECIFIC_DEFINES += TARGET_KERNEL_CONFIG=altair_glacier_defconfig

# Extra glacier overlay
PRODUCT_PACKAGE_OVERLAYS += vendor/altair/overlay/glacier
