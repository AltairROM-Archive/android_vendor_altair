...
#
PRODUCT_NAME := altair_vibrantmtd
...
#PRODUCT_SPECIFIC_DEFINES += TARGET_KERNEL_CONFIG=altair_vibrantmtd_defconfig

# Extra galaxys overlay
PRODUCT_PACKAGE_OVERLAYS += vendor/altair/overlay/vibrantmtd
