...
#PRODUCT_SPECIFIC_DEFINES += TARGET_KERNEL_CONFIG=altair_coconut_defconfig

# Extra coconut overlay
PRODUCT_PACKAGE_OVERLAYS += vendor/altair/overlay/coconut
