...
#PRODUCT_SPECIFIC_DEFINES += TARGET_KERNEL_CONFIG=altair_smultron_defconfig

# Extra smultron overlay
PRODUCT_PACKAGE_OVERLAYS += vendor/altair/overlay/smultron
