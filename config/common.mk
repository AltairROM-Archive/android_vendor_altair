...
bootanimation_sizes := $(subst .zip,, $(shell ls vendor/altair/prebuilt/common/bootanimation))
...
PRODUCT_BOOTANIMATION := vendor/altair/prebuilt/common/bootanimation/halfres/$(TARGET_BOOTANIMATION_NAME).zip
else
PRODUCT_BOOTANIMATION := vendor/altair/prebuilt/common/bootanimation/$(TARGET_BOOTANIMATION_NAME).zip
endif
endif
...
PRODUCT_FULL_VERSION := $(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(ALTAIR_BUILDTYPE)-$(shell date +%Y%m%d-%H%M)
